...
<script src="assets/js/jquery-steps/jquery-1.10.2.min.js"></script>
<script src="assets/js/jquery-steps/jquery-1.11.1.min.js"></script>
<script src="assets/js/jquery-steps/jquery-1.9.1.min.js"></script>
<script src="assets/js/jquery-steps/jquery.cookie-1.3.1.js"></script>
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <div>
                                    <ul class="nav justify-content-start nav-tabs-custom rounded card-header-tabs"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#modal-details"
                                                role="tab" id="sms">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" value="48" disabled
                                                                class="form-control" id="specificSizeInputGroupUsername"
                                                                placeholder="Username">
                                                            <div class="input-group-text">%</div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-text">£</div>
                                                            <input type="number" value="22.20" disabled
                                                                class="form-control" id="specificSizeInputGroupUsername"
                                                                placeholder="Username">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-text">£</div>
                                                            <input type="number" value="50.25" disabled
                                                                class="form-control" id="specificSizeInputGroupUsername"
                                                                placeholder="Username">
                                                            <div class="input-group-text">Cost</div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-text">£</div>
                                                            <input type="number" value="35.48" disabled
                                                                class="form-control" id="specificSizeInputGroupUsername"
                                                                placeholder="Username">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-text">£</div>
                                                            <input type="number" value="74.29" disabled
                                                                class="form-control" id="specificSizeInputGroupUsername"
                                                                placeholder="Username">
                                                            <div class="input-group-text">Sell</div>
                                                        </div>
